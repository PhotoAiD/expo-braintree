...
exports.EXCEPTION_TYPES = exports.ERROR_TYPES = exports.BoolValue = exports.BTPayPalRequestUserAction = exports.BTPayPalCheckoutIntent = void 0;
let EXCEPTION_TYPES = exports.EXCEPTION_TYPES = /*#__PURE__*/function (EXCEPTION_TYPES) {
  ...
  EXCEPTION_TYPES["PAYPAL_DISABLED_IN_CONFIGURATION"] = "ExpoBraintree:`Paypal disabled in configuration";
...
let ERROR_TYPES = exports.ERROR_TYPES = /*#__PURE__*/function (ERROR_TYPES) {
  ...
  ERROR_TYPES["PAYPAL_DISABLED_IN_CONFIGURATION_ERROR"] = "PAYPAL_DISABLED_IN_CONFIGURATION_ERROR";
  ERROR_TYPES["DATA_COLLECTOR_ERROR"] = "DATA_COLLECTOR_ERROR";
  ERROR_TYPES["CARD_TOKENIZATION_ERROR"] = "CARD_TOKENIZATION_ERROR";
  ERROR_TYPES["APPLE_PAY_NOT_AVAILABLE"] = "APPLE_PAY_NOT_AVAILABLE";
  ERROR_TYPES["APPLE_PAY_TOKENIZATION_ERROR"] = "APPLE_PAY_TOKENIZATION_ERROR";
  ERROR_TYPES["GOOGLE_PAY_NOT_AVAILABLE"] = "GOOGLE_PAY_NOT_AVAILABLE";
  ERROR_TYPES["GOOGLE_PAY_TOKENIZATION_ERROR"] = "GOOGLE_PAY_TOKENIZATION_ERROR";
  ERROR_TYPES["THREE_D_SECURE_NOT_ABLE_TO_SHIFT_LIABILITY"] = "THREE_D_SECURE_NOT_ABLE_TO_SHIFT_LIABILITY";
  ERROR_TYPES["THREE_D_SECURE_LIABILITY_NOT_SHIFTED"] = "THREE_D_SECURE_LIABILITY_NOT_SHIFTED";
  ERROR_TYPES["THREE_D_SECURE_VERIFICATION_FAILED"] = "THREE_D_SECURE_VERIFICATION_FAILED";
  ERROR_TYPES["THREE_D_SECURE_AUTHENTICATION_FAILED"] = "THREE_D_SECURE_AUTHENTICATION_FAILED";
  return ERROR_TYPES;
}({});
